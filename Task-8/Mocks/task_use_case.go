...
func (_m *TaskUseCase) AddTask(ctx context.Context, task *domain.Task) (domain.Task, error) {
...
func (_m *TaskUseCase) DeleteTask(ctx context.Context, id primitive.ObjectID) error {
...
func (_m *TaskUseCase) UpdateTask(ctx context.Context, id primitive.ObjectID, updatedTask *domain.Task) (domain.Task, error) {
