...
func (_m *TaskRepository) AddTask(ctx context.Context, task *domain.Task) (domain.Task, error) {
...
func (_m *TaskRepository) DeleteTask(ctx context.Context, id primitive.ObjectID) error {
...
func (_m *TaskRepository) GetTaskByID(ctx context.Context, id primitive.ObjectID) (domain.Task, error) {
	ret := _m.Called(ctx, id)
...
func (_m *TaskRepository) UpdateTask(ctx context.Context, id primitive.ObjectID, updatedTask *domain.Task) (domain.Task, error) {
